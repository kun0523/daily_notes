...
- ![LinearQuantization](linear_quant.png)
- 需要定义两个参数
  ...
  - ![quant_param_scale_zero](quant_param_scale_zero.png)
```python
import torch 
...
## 对不同粒度进行量化
![Quant_Diff_Granularities](不同粒度的量化.png)
...
## 权重量化+激活函数量化
![Quantization_weight_active](quant_weight_active.png)
